...
<form action="<?php echo e(route('asas.store')); ?>" method="POST" style="margin-top: 20px;">
<?php echo csrf_field(); ?>
    <div class="row">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\wplocal\laragon\www\monir\resources\views/asa/create_asa.blade.php ENDPATH**/ ?>